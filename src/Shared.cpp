...
TDigitalPin Sensor1("Pir1", SENSOR1_PIN, INPUT); // GPIO34 - GPIO39 input only no PU/PD circuitry - use external PU/PD resistor
TDigitalPin Sensor2("Pir2", SENSOR2_PIN, INPUT);
TDigitalPin Sensor3("Pir3", SENSOR3_PIN, INPUT);
TDigitalPin Sensor4("Pir4", SENSOR4_PIN, INPUT);
TDigitalPin Sensor5("Pir5", SENSOR5_PIN, INPUT_PULLDOWN);
TDigitalPin Sensor6("Pir6", SENSOR6_PIN, INPUT_PULLDOWN);
TDigitalPin Sensor7("Pir7", SENSOR7_PIN, INPUT_PULLDOWN);
TDigitalPin SensorDoor("Door", SENSOR8_PIN, INPUT_PULLUP);
